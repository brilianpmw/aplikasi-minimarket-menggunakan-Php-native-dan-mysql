...
<tr>
<td align="center"><form id="form_filter" name="form_filter" method="post" action="<?php
$_SERVER['PHP_SELF'];?>">
Tanggal Awal :
...
<input type="submit" name="button_print" id="button-print" value="Print" onclick="print()"/>
</form></td>
</tr>
</table>
</div>
...
for($i=0;$i<$count_faktur;$i++){
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>Supplier:<?php echo $kd_supplier;?></td>
    <td>&nbsp;</td>
    </tr>
    <tr>
    <td>Tanggal:<?php echo $atas_nama;?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<td>&nbsp;</td>
<td><?php echo $total_seluruh_beli;?></td>
</tr>
</table>
</div>
</body>

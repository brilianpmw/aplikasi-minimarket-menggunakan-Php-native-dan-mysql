...
if(isset($_POST['button_add'])){
	...
	$query_insert="INSERT INTO tabel_rinci_pembelian (no_faktur_pembelian,kd_barang,nm_barang,satuan,jumlah,harga,sub_total_beli)VALUES('".$no_faktur."','".$_kd_barang."','".$nm_barang."','".$satuan."','".$jml."','".$hrg."','".$sub_total."')";
